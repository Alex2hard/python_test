...
html = HTMLBuilder()
html.set_title("Hello")
html.add_paragraph("Первый параграф")
html.add_link("https://www.youtube.com/watch?v=dQw4w9WgXcQ", "нажми на меня!")
html.add_div("съешь ещё этих мягких французских булок да выпей чаю")
html.add_h("съешь ещё этих мягких французских булок да выпей чаю")
html.add_img("https://youtu.be/dQw4w9WgXcQ")
html.change_text("съешь ещё этих мягких французских булок да выпей чаю")
html.add_list(["съешь ещё этих мягких французских булок да выпей чаю", "Конец"])
print(html.render())